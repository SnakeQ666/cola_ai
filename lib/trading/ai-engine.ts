...
交易规则：
- **核心原则：优先持有，减少频繁交易**
- **手续费成本**：每次买卖的手续费约为 0.1%，盈亏必须足够覆盖手续费
- **分析所有币种，但只在信号非常明确时才交易**
- RSI > 75 超买且趋势反转 → 考虑卖出，< 25 超卖且趋势反转 → 考虑买入
- EMA12上穿EMA26金叉且持续 → 买入，下穿死叉且持续 → 卖出
- 价格突破布林带上轨且RSI>70 → 卖出，跌破下轨且RSI<30 → 买入
- **有持仓时，必须结合盈亏状况和持仓时间决策（避免频繁交易）：**
  - **盈利平仓条件**（必须同时满足）：
    - 盈利幅度 ≥ 8%（覆盖手续费后仍有足够利润），且
    - 出现明确的趋势反转信号（如：MACD 死叉、RSI 极端超买、价格跌破关键支撑），或
    - 盈利幅度 ≥ 15%（无论趋势如何都建议止盈）
    - **禁止**：仅因为小幅盈利（< 8%）就卖出
  - **亏损平仓条件**（必须同时满足）：
    - 亏损幅度 ≥ 10%（避免因小幅波动就止损），且
    - 趋势明显恶化（如：MACD 持续背离、价格跌破关键支撑、RSI 极端超卖），或
    - 亏损幅度 ≥ 15%（立即止损）
    - **禁止**：仅因为小幅亏损（< 10%）就卖出
  - **持仓时间考虑**：
    - 持仓时间 < 2小时：除非极端情况（亏损 > 15% 或盈利 > 15%），否则继续持有
    - 持仓时间 2-8小时：需要明确的趋势反转信号才卖出
    - 持仓时间 ≥ 8小时：可以更灵活地根据盈亏和趋势决定
  - **趋势延续判断**：
    - 如果当前趋势仍在延续，即使有小幅盈利/亏损，也应继续持有
    - 只有在趋势明确反转或达到较大盈亏目标时才卖出
- **卖出决策优先级：止损（>15%）> 止盈（>15%）> 趋势反转 > 新买入**
...
4. 根据市场信心和风险等级合理分配金额
5. **如果建议HOLD，交易金额填0（这是最优先的选择，除非有非常明确的交易信号）**
6. **根据盈亏状况和持仓时间做决策（避免频繁交易）：**
   - **盈利平仓**：必须盈利 ≥ 8% 且有趋势反转信号，或盈利 ≥ 15%（无论趋势如何）
   - **亏损平仓**：必须亏损 ≥ 10% 且趋势恶化，或亏损 ≥ 15%（立即止损）
   - **持仓时间 < 2小时**：除非极端情况，否则继续持有
   - **持仓时间 2-8小时**：需要明确趋势反转才卖出
   - **持仓时间 ≥ 8小时**：可以更灵活地根据盈亏和趋势决定
7. **优先持有，减少交易频率**：
   - 如果当前持仓趋势仍在延续，即使有小幅盈利/亏损，也应继续持有
   - 只有在趋势明确反转或达到较大盈亏目标时才交易
   - 避免因为小幅波动就买卖
8. **分析所有币种，但只在信号非常明确时才交易**
9. **灰尘持仓无法交易，忽略即可，只关注可交易持仓**
10. **卖出时可以部分卖出或全部卖出，根据市场情况决定，但优先选择持有**`;
